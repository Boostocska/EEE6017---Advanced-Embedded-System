...
# 1 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\\pic\\include\\p18cxxx.h" 1 3
...
# 5 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\\pic\\include\\p18cxxx.h" 2 3
# 7 "main.c" 2
...
char readMatchCode(char* codeToMatch, Bool** isEnabled){
    ...
    while(*isEnabled){
        ...
        if(pressedKey == codeToMatch[codePosition]){
            codePosition++;
...
void __attribute__((picinterrupt(("")))) isr(void){
    ...
    INTCONbits.TMR0IF = 0;
    preciseTimer += 256;
    if(preciseTimer >= 1000000 && currentState != 4){
        preciseTimer -= 1000000;
        toggleBuzzer(0);
    }
    if(preciseTimer >= 3000000 && currentState == 4){
